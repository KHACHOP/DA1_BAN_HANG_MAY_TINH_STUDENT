...
import service.ChiTietSanPhamService1;
...
public class SanPhamView1 extends javax.swing.JFrame {
 int index = -1;
    ...
    ChiTietSanPhamService1 ctspsv = new ChiTietSanPhamService1();
    List<String> listLoaiThuocTinh = new ArrayList<>();
    /**
     * Creates new form SanPhamView1
     */
    public SanPhamView1() {
        initComponents();
        ...
        cboLoaiThuocTinh();
        addCbo(listLoaiThuocTinh);
        addCbo(ctspsv.getTenChatLieu());
        addCbo(ctspsv.getTenHang());
        addCbo(ctspsv.getTenKichCo());
        addCbo(ctspsv.getTenMauSac());
...
//        addCboLoc(ctspsv.getTenChatLieuALL(), cboChatLieu1);
    ...
    private void addCbo(List<String> list) {
...
private void addCboLoc(List<String> list, JComboBox md) {
 ...
 private KichCo readFormKichCo() {
    ...
    private ChiTietSanPham readCTSP() {
        ...
        String maVach = null;
//        ChiTietSanPham ctsp = new ChiTietSanPham(id_SanPham, id_MauSac, id_KichCo, id_Hang, id_Hang, soLuongCon, maCTSP, giaBan);
           ChiTietSanPham ctsp = new ChiTietSanPham(maCTSP, id_SanPham, giaBan, soLuongCon, id_MauSac, id_KichCo, id_Hang, id_Hang, mota, maVach, trangThaiXoa, mota, maVach);
    ...
    private void initComponents() {
        ...
        tblSanPham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã SP", "Tên SP", "Trạng Thái Bán", "Ngày Tạo", "Ngày Sửa Cuối"
            }
        ));
        ...
        tblCTSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã CTSP", "Tên Sản Phẩm", "Đơn Giá", "Số Lượng", "Màu Sắc", "Kích Cỡ", "Hãng", "Ngày Tạo", "Ngày Sửa Cuối", "Trạng Thái", "Mô Tả", "Mã Vạch"
            }
        ));
    ...
    private void myButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton4ActionPerformed
        ...
        fillToTableCTSP(ctspsv.locCTSP(trangThaiXoa, trangThaiXoa, trangThaiXoa, trangThaiXoa, trangThaiXoa, trangThaiXoa));
