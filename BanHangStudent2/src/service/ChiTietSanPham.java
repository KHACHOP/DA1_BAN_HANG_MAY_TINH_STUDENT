...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(String string, String string1, double aDouble, int aInt, String string2, String string3, String string4, int trangThaiXoa1, String mota1, String maVach1) {
    }
