...
import SEVIEC.HoaDonChiTietService;
import SEVIEC.HoaDonService;
...
//        headerRow.createCell(7).setCellValue("Tiền Thừa");
...
//        }
        ...
        int i = 1;
        DefaultTableModel defaultTableModelHoaDonChiTiet = (DefaultTableModel) tblHoaDonChiTiet.getModel();
        defaultTableModelHoaDonChiTiet.setRowCount(0);
        ...
        for (HoaDonChiTietDTO hoaDonChiTietDTO : hoaDonChiTietDTOs) {
            ...
            defaultTableModelHoaDonChiTiet.addRow(rowData);
        }
    }
    ...
    private void tblHoaDonMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        List<SEVIEC.HoaDonChiTietDTO> hoaDonChiTietDTOList = hoaDonChiTietService.getHoaDonChiTietDTO(Integer.valueOf(maHoaDon));
    ...
    private void writeExcel(List<HoaDonDTO> findAllHoaDon) {
